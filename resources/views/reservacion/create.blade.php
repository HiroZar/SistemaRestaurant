        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('reservacions.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="box box-info padding-1">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('Cliente') }}
                                        {{ Form::text('idCliente', $reservacion->idCliente, ['id' => 'idCliente','class' => 'form-control' . ($errors->has('idCliente') ? ' is-invalid' : ''), 'placeholder' => 'Id Cliente', 'disabled' => 'disabled']) }}
                                        <br>
                                        {{ Form::text('', $reservacion->idCliente, ['id' => 'dniCliente','class' => 'form-control' . ($errors->has('idCliente') ? ' is-invalid' : ''), 'placeholder' => 'DNI Cliente', 'disabled' => 'disabled']) }}
                                        <br>
                                        {{ Form::text('', $reservacion->idCliente, ['id' => 'nombreCliente','class' => 'form-control' . ($errors->has('idCliente') ? ' is-invalid' : ''), 'placeholder' => 'Nombre Cliente', 'disabled' => 'disabled']) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::date('fechaAtencion', date('Y-m-d'), ['class' => 'form-control' . ($errors->has('fechaAtencion') ? ' is-invalid' : ''), 'placeholder' => 'Fechaatencion']) }}

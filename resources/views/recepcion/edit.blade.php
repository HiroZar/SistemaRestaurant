               ...
               <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    ...
                    <input id="personal_id" class="form-control" type="text" name="personal_id" value="{{ $ordenCompra->personal_id }}" readonly >
                  </div>
                  <div class="col-6" style="border">
                    <label for="idProveedor">Proveedor</label>
                    <input id="idProveedor" class="form-control" type="text" name="idProveedor" value="{{ $ordenCompra->proveedor->compañia }}" readonly > 
                  </div>
                  ...
                  <div class=" col-6">
                       ...
                       <button type="submit" class="form-control btn btn-primary btn-lg btn-block "> <i class="fa fa-fw fa-lg fa-plus"></i>Guardar</button>
                   </div>
                   <div class="col-12" style="border">
                ...
                <div class="row ">                 
                  <div class="col-6">
                    ...
                    <select class="form-control "  id="producto">
                      <option value="">Seleccione</option>
                       ...
                       <option value="{{$item->idproducto	}}_{{ $item->nombre }}_{{ $item->stock }}">{{$item->nombre}}</option> 
                    @endforeach
                    </select>
                  ...
                  <div class="col-6">
                    ...
                    <div class=" col-6">
                        ...
                        <button  class="form-control btn btn-success btn-lg  btn-block " style="margin: 20px 0px 20px 0px "  id="add"> Agregar</button>
                    ...
                    <div class="col-8"></div>
                    <div class="col-4">
                        <input type="hidden"  style="width: 100%" class="form-control  float-right" id="total" name="total" value="0" readonly>
                    </div>
                </div>
        ...
        let cantidad = $('#cantidad').val();
          ...
          if (validate(producto[0])==true) {
            let row = '<tr id="row' + index + '"><td><input type="hidden" name="list_producto[]" value="' +
                producto[0] + '"><input type="hidden" name="list_cantidad[]" value="' + cantidad + '"><input type="hidden" name="list_cantidadA[]" value="' + producto[2] + '">' + i++ +
                '</td><td>' + producto[1] + '</td><td>'+producto[2]+'</td><td>' + cantidad + '</td><td><button onclick="remove(' +
                index + ' , ' + (producto[2] +

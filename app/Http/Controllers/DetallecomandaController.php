...
class DetallecomandaController extends Controller
{
    ...
    {
        $detallecomanda = Detallecomanda::where('idcomanda', $idcomanda)->where('idplato', $idplato)->first();
    ...
    public function update(Request $request, Detallecomanda $detallecomanda)
    {
        ...
        $detallecomanda::where('idComanda', $idComanda)->where('idPlato', $idPlato)->update($request->only(['precio', 'cantidad']));;
